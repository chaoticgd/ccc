...
const std::vector<ImporterFlagInfo> IMPORTER_FLAGS = {
	...
	{
		DONT_DEDUPLICATE_SYMBOLS,
		"--dont-deduplicate-symbols",
		{
	...
	{
		DONT_DEDUPLICATE_TYPES,
		"--dont-deduplicate-types",
		{
	...
	{
		INCLUDE_GENERATED_MEMBER_FUNCTIONS,
	...
	{
		NO_LINKONCE_SECTIONS,
		"--no-linkonce-sections",
		{
	...
	{
		NO_OPTIMIZED_OUT_FUNCTIONS,
		"--no-optimized-out-functions",
		{
