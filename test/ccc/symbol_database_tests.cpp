...
TEST(CCCSymbolDatabase, DestroySymbolsFromSource)
{
	...
	Result<SymbolSource*> symbol_table_source = database.symbol_sources.create_symbol(
		"Big Symbol Table", SymbolSourceHandle());
	CCC_GTEST_FAIL_IF_ERROR(symbol_table_source);
	SymbolSourceHandle symbol_table_handle = (*symbol_table_source)->handle();

	Result<SymbolSource*> user_defined_source = database.symbol_sources.create_symbol(
		"User Defined", SymbolSourceHandle());
...
TEST(CCCSymbolDatabase, DestroyFunction)
{
	...
	Result<ParameterVariable*> parameter_variable = database.parameter_variables.create_symbol(
		"param", (*source)->handle());
